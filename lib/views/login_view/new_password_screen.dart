...
import '../../view_models/login_view_models/accuracy_otp_view_model.dart';
import '../../view_models/login_view_models/new_password_view_model.dart';
...
class NewPasswordScreen extends StatelessWidget {
  ...
  final AccuracyOTPViewModel accuracyOTPViewModel = Get.find();
          ...
          child: Column(
            children: [
              AppBarContainer(
                ...
                event: () {
                  accuracyOTPViewModel.showIndicator(false);
                  Get.back();
                },
              ),
              SizedBox(
              ...
              Obx(
                () => TextInputContainer(
                  ...
                  requiredValue: true,
                  error:
                      newPasswordViewModel.formError.value.password.isNotEmpty,
              ...
              Obx(
                () => TextInputContainer(
                  ...
                  errorText:
                      newPasswordViewModel.formError.value.confirmPassword,
              ...
              Container(
                ...
                child: TextButton(
                  onPressed: () {
                    newPasswordViewModel.validate(passwordController.text,
